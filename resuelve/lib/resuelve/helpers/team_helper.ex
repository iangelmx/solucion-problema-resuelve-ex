defmodule Resuelve.Helpers.TeamHelper do
  ...
  def calculate_complicance_by_team( scored_goals, minimum_goals ) when scored_goals >= minimum_goals do
    100.0
  end
  def calculate_complicance_by_team( scored_goals, minimum_goals ) when scored_goals < minimum_goals and minimum_goals >0 do
