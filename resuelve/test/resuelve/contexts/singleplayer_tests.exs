...
defmodule Resuelve.SingleplayerTests do
  ...
  test "Adding the alcance_ind key value to a single player with no data of goals goal" do
    input = %Jugador{goles_minimos: nil, goles: 10000000000000000000}
    simulation_res = %Jugador{goles_minimos: nil, goles: 10000000000000000000, alcance_ind: nil}
    assert JugadorHelper.get_single_compliance( input ) == simulation_res
  end
  ...
  test "Getting the complete salary for a list of players with different characteristics" do
    input = [
      %Jugador{bono: 5980, sueldo: -4198048, alcance_ind: nil, alcance_team: 100},
      %Jugador{bono: 5000, sueldo: 10000, alcance_ind: 93.33, alcance_team: 100},
      %Jugador{bono: -41981, sueldo: 12651650849804, alcance_ind: 100, alcance_team: 59.5}
    ]
    simulation_res = [
      %Jugador{bono: 5980, sueldo: -4198048, alcance_ind: nil, alcance_team: 100, sueldo_completo: nil, failed: true},
      %Jugador{bono: 5000, sueldo: 10000, alcance_ind: 93.33, alcance_team: 100, sueldo_completo: 14833.25, failed: false},
      %Jugador{bono: -41981, sueldo: 12651650849804, alcance_ind: 100, alcance_team: 59.5, sueldo_completo: 12651650849804, failed: false}
    ]
